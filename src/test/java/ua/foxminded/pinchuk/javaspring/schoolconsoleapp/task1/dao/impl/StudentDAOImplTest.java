...
import ua.foxminded.pinchuk.javaspring.schoolconsoleapp.task1.dao.Source;
...
class StudentDAOImplTest {
    ...
    @ParameterizedTest
    @Order(1)
    @MethodSource("ua.foxminded.pinchuk.javaspring.schoolconsoleapp.task1.dao.Source#provideStudents")
    ...
    @ParameterizedTest
    @Order(3)
    @MethodSource("ua.foxminded.pinchuk.javaspring.schoolconsoleapp.task1.dao.Source#provideStudentsFromCourse")
